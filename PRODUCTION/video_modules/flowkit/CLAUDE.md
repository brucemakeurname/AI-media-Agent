...
> **Solo Flows fork (2026-08-07):** adds Omni Flash video generation (`/fk-omni-video-gen`) and
> corrects an upstream doc bug — 1080p upscale works on `PAYGATE_TIER_ONE`, not TIER_TWO-only.
> See `README.md` fork notice and `docs/omni-discovery-log.md`.
...
| `/fk-omni-video-gen` | Omni Flash text/reference-to-video, durations 4/6/8/10s (Solo Flows fork addition) |
